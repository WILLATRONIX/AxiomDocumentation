...
| Shape                | Allows you to change the path shape. This setting is not available for the Bresenham line.                                                                                                                                                                |
| Radius               | Used to adjust the width of the chosen shape between a spherical or flat surface. The clipboard shape allows for drawing a path using the current [Clipboard](/editor/windows/clipboard.md). The shape drop-down is not available for the Bresenham line. |
